...
#csv:n lukua varten
#tätä raakiletta voidaan käyttä myös matkoihin
#PÄIVITETTY: korjattu bugi, jossa ensimmäinen kolumni ei tulostunut
#voidaan lisätä FID tarvittaessa (en usko, että tarvetta?)
def lueAsemaCsv():
